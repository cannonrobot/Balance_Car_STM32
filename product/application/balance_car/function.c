...
int32_t Speed_L=0;
int32_t Speed_R=0;
TIM_HandleTypeDef        TimHandleT1;//±àÂëÆ÷
TIM_HandleTypeDef        TimHandleT2;//¶æ»ú
TIM_HandleTypeDef        TimHandleT3;//¶æ»ú
TIM_HandleTypeDef        TimHandleT4;//µç»ú
TIM_HandleTypeDef        TimHandleT5;//±àÂëÆ÷
...
void Get_Speed(void){
  uint32_t TempL,TempR;
    TempL=HAL_TIM_ReadCapturedValue(&TimHandleT1, TIM_CHANNEL_1);//±àÂëÆ÷¶ÁÈ¡
	Speed_L=TempL;
 /*
     ...
     if(Speed_L<-20000){
        ...
        Speed_L-=65535;} 
	*/
    TempR=HAL_TIM_ReadCapturedValue(&TimHandleT5, TIM_CHANNEL_1);//±àÂëÆ÷¶ÁÈ¡
		Speed_R=TempR;
  /*
